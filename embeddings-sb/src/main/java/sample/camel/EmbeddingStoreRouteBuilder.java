...
public class EmbeddingStoreRouteBuilder extends RouteBuilder {
    ...
    @Bean
    EmbeddingStore<TextSegment> milvus() {
        LOG.info("Setting up Milvus configuration with container: {}", milvus.getDockerImageName());
	...
	public void configure() throws Exception {
        ...
        .to("langchain4j-embeddingstore:bean:milvus")
        .to("log:input");
	}
}
